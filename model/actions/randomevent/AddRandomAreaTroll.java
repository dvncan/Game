...
/**
 * Add trolls to random area
 * @author Team 2
 * @since Build 2
 */
public class AddRandomAreaTroll extends RandomEventCardAction
{
	 ...
	 * @throws Exception 
	 */
	public AddRandomAreaTroll(List<String> args) throws Exception
	{
	...
	public boolean execute(GameManager gameManager) 
	{
		for (int i = 0; i < repeat; i ++)
		{
			try
			{
				...
				if (!eventStopped)
				{
					ActionManager.addTroll(gameManager, randomArea);
					break;
				}
			}
			catch (Exception ex)
